...
const personalMovieDB = {
   ...
   detectPersonalLevel: function() {
       ...
       wrireYourGeners: function() {
        //    for (let i = 1; i <= 3; i++) {
        //        let gener = prompt(`Напишите Ваш любимый жанр под номером: ${i}`);
        //        if (gener == "" || gener == null){
        //            console.log("Ypu write wrong text");
        //            i--;
        //        } else{
        ...
        //     console.log(`${i + 1}: ${item} внутри масиива ${personalMovieDB.genres}`);
        //  })
        for (let i = 1; i < 2; i++) {
            let gener = prompt(`Напишите Ваши любимые жанры через запятые`);
            if (gener == "" || gener == null){
                console.log("Ypu write wrong text");
                i--;
            } else{
                personalMovieDB.genres[i] = gener.split(", ");
                personalMovieDB.genres.sort();
            }

        }
        personalMovieDB.genres.forEach((item, i) => {
         console.log(`${i + 1}: ${item} внутри масиива s`);
      })
       },
